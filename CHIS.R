...
theme(axis.title.x = element_text(color = "red", face = "bold"), axis.title.y = element_text(color = "red", face = "bold"), axis.text = element_text(face = "bold"))

# BMI histogram
ggplot(adult, aes(x = BMI_P)) +
geom_histogram(binwidth = .8, color = "purple") +
theme(axis.title.x = element_text(color = "green", face = "bold"), axis.title.y = element_text(color = "green", face = "bold"), axis.text = element_text(face = "bold"))
